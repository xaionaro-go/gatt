...
var knownCharacteristics = map[string]struct{ Name, Type string }{
	...
	"d0611e78-bbb4-4591-a5f8-487910ae4366": {Name: "Apple Continuity Service"},
	"7905f431-b5ce-4e99-a40f-4b1e122d00d0": {Name: "Apple Notification Center Service"},
	"69d1d8f3-45e1-49a8-9821-9bbdfdaad9d9": {Name: "Control Point"},
	"9fbf120d-6301-42d9-8c58-25e699a21dbd": {Name: "Notification Source"},
	"22eac6e9-24d6-4bb5-be44-b36ace7c7bfb": {Name: "Data Source"},
	"89d3502b-0f36-433a-8ef4-c502ad55f8dc": {Name: "Apple Media Service"},
	"9b3c81d8-57b1-4a8a-b8df-0e56f7ca51c2": {Name: "Remote Command"},
	"2f7cabce-808d-411f-9a0c-bb92ba96c102": {Name: "Entity Update"},
	"c6b2f38c-23ab-46d8-a6ab-a3a870bbd5d7": {Name: "Entity Attribute"},
}
